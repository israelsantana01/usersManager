...
public class EditStudent extends javax.swing.JDialog {
    ...
    public EditStudent(java.awt.Frame parent, Students student, int rowId)
    { 
        initComponents();
        this.id = rowId;
        fillInputs(student);
    ...
    private EditStudent(JFrame jFrame)
    {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    
    private void fillInputs(Students student) {
        txtUsername.setText(student.getUsername());
        txtSubject.setText(student.getSubject());
        txtYear.setText(Integer.toString(student.getYear_of_entry()));
    }
    ...
    private void initComponents()
    {
        ...
        jLabel1.setText("Alteração de Estudante");
        ...
        jLabel5.setText("Ano de entrada");
        ...
        btnUpdate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/save.png"))); // NOI18N
        ...
        btnCancel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/cancel.png"))); // NOI18N
    ...
    {//GEN-HEADEREND:event_btnUpdateMouseClicked
        DBOperations operations = new DBOperations();
        Students studentAltered = new Students();
        studentAltered.setId(this.id); 
        studentAltered.setUsername(txtUsername.getText());
        studentAltered.setSubject(txtSubject.getText());    
        studentAltered.setYear_of_entry(Integer.parseInt(txtYear.getText()));    
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run()
            {
                EditStudent dialog = new EditStudent(new javax.swing.JFrame());
